    ...
    if timeSig == [4,4]:
        if common == 1:
            ...
            if num1 < 0.25:  # 25% chance to pick a common/simple rhythm regardless of interval
                ...
                print('going with random choice because 25% chance to no matter what')
                if numOfNotes == 1:
                    return ['1']
                elif numOfNotes == 2:
                    choices = [['2~', '4', '4'], ['2', '2']]
                    ...
                    choices = [['4~', '8', '8', '8', '8', '8', '8'], ['4', '4', '8', '8', '8', '8'], ['4', '8', '8', '4', '8', '8'],
                               ['4', '8', '8', '8', '8', '4'], ['8', '8', '4~', '8', '8', '8', '8'], ['8', '8', '4', '4', '8', '8'],
                               ['8', '8', '4', '8', '8', '4'], ['8', '8', '8', '8', '4~', '8', '8'], ['8', '8', '8', '8', '4', '4']]
                elif numOfNotes == 7:
                    choices = [['4', '8', '8', '8', '8', '8', '8'], ['8', '8', '4', '8', '8', '8', '8'], ['8', '8', '8', '8', '4', '8', '8'],
                               ['8', '8', '8', '8', '8', '8', '4']]
                elif numOfNotes == 8:
                    choices = [['8', '8', '8', '8', '8', '8', '8', '8']]
                else:  # should never get here, unless numOfNotes = default 0
                    choices = [['1'],
                ...
                if interval == 0:
                    ...
                    print('going with random choice')
                    choices = [['1'],
                               ['2~', '4', '4'], ['2~', '4', '8', '8'], ['2~', '8', '8', '4'], ['2~', '8', '8', '8', '8'],
                               ['2', '2'], ['2', '4~', '8', '8'], ['2', '4', '4'], ['2', '4', '8', '8'], ['2', '8', '8', '4'], ['2', '8', '8', '8', '8'],
                               ['4~', '8', '8', '2'], ['4~', '8', '8', '4~', '8', '8'], ['4~', '8', '8', '4', '4'],
