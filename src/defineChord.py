    ...
    if key == 'C':
        if major == 1:
            return {
                ...
                '543/3': [['fs', 'a', 'b', 'ds'],2],
                '52/3': [['a', 'b', 'ds', 'fs'],3],
                '5/4': [['c', 'e', 'g'],0], # 5/4 is just a 1 chord, but for completion...
                '56/4': [['e', 'g', 'c'],1], # 56/4 is just a 16 chord, but for completion...
                '564/4': [['g', 'c', 'e'],2], # 564/4 is just a 164 chord, but for completion...
                '57/4': [['c', 'e', 'g', 'bf'],0],
                '565/4': [['e', 'g', 'bf', 'c'],1],
                '543/4': [['g', 'bf', 'c', 'e'],2],
                '52/4': [['bf', 'c', 'e', 'g'],3],
